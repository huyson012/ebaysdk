...
/**
 *
 * @property \SONHH\eBaySDK\BusinessPoliciesManagement\Types\Amount $domesticInsuranceFee
 * @property string $domesticInsuranceOption
 * @property string $intlInsuranceOption
 * @property \SONHH\eBaySDK\BusinessPoliciesManagement\Types\Amount $intlInsuranceFee
 */
class Insurance extends \SONHH\eBaySDK\Types\BaseType
{
    /**
