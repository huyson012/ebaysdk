...
/**
 *
 * @property \SONHH\eBaySDK\Account\Types\Amount $maxSoldInventoryValue
 * @property integer $maxSoldQuantity
 * @property \SONHH\eBaySDK\Account\Types\Amount $minSoldInventoryValue
 * @property integer $minSoldQuantity
 * @property \SONHH\eBaySDK\Account\Types\TimeDuration $period
 */
class SoldAggregatedMetrics extends \SONHH\eBaySDK\Types\BaseType
{
    /**
