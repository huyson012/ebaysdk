...
/**
 *
 * @property \SONHH\eBaySDK\Account\Types\ErrorDetailV3[] $errors
 * @property \SONHH\eBaySDK\Account\Types\ErrorDetailV3[] $warnings
 */
class GetFulfillmentPoliciesByMarketplaceRestResponse extends \SONHH\eBaySDK\Account\Types\FulfillmentPolicyResponse
{
    use StatusCodeTrait;
