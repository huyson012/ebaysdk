 ...
 */
class ReturnManagementBaseService extends \SONHH\eBaySDK\Services\BaseService
{
    /**
    ...
    public static function getConfigDefinitions()
    {
        ...
        return $definitions + [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \SONHH\eBaySDK\ReturnManagement\Services\ReturnManagementService::API_VERSION
            ],
            'authToken' => [
                'valid' => ['string'],
                'required' => true
