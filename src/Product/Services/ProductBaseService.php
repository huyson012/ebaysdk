 ...
 */
class ProductBaseService extends \SONHH\eBaySDK\Services\BaseService
{
    /**
    ...
    {
        parent::__construct('https://svcs.ebay.com/services/marketplacecatalog/ProductService/v1', 'https://svcs.sandbox.ebay.com/services/marketplacecatalog/ProductService/v1', $config);
    }
    ...
    public static function getConfigDefinitions()
    {
        ...
        return $definitions + [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \SONHH\eBaySDK\Product\Services\ProductService::API_VERSION
            ],
            'globalId' => [
                'valid' => ['string']
            ]
