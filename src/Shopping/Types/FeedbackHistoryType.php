...
/**
 *
 * @property \SONHH\eBaySDK\Shopping\Types\FeedbackPeriodType[] $BidRetractionFeedbackPeriods
 * @property \SONHH\eBaySDK\Shopping\Types\FeedbackPeriodType[] $NegativeFeedbackPeriods
 * @property \SONHH\eBaySDK\Shopping\Types\FeedbackPeriodType[] $NeutralFeedbackPeriods
 * @property \SONHH\eBaySDK\Shopping\Types\FeedbackPeriodType[] $PositiveFeedbackPeriods
 * @property \SONHH\eBaySDK\Shopping\Types\FeedbackPeriodType[] $TotalFeedbackPeriods
 * @property integer $UniqueNegativeFeedbackCount
 * @property integer $UniquePositiveFeedbackCount
 * @property \SONHH\eBaySDK\Shopping\Types\AverageRatingDetailsType[] $AverageRatingDetails
 * @property integer $NeutralCommentCountFromSuspendedUsers
 * @property integer $UniqueNeutralFeedbackCount
 */
class FeedbackHistoryType extends \SONHH\eBaySDK\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        'BidRetractionFeedbackPeriods' => [
            'type' => 'SONHH\eBaySDK\Shopping\Types\FeedbackPeriodType',
            'repeatable' => true,
            'attribute' => false,
        ...
        'AverageRatingDetails' => [
            'type' => 'SONHH\eBaySDK\Shopping\Types\AverageRatingDetailsType',
            'repeatable' => true,
            'attribute' => false,
