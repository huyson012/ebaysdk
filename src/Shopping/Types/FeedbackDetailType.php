 ...
 * @property \SONHH\eBaySDK\Shopping\Enums\CommentTypeCodeType $CommentType
 * @property string $FeedbackResponse
 * @property string $FollowUp
 * @property string $ItemID
 * @property \SONHH\eBaySDK\Shopping\Enums\TradingRoleCodeType $Role
 * @property string $ItemTitle
 * @property \SONHH\eBaySDK\Shopping\Types\AmountType $ItemPrice
 ...
 */
class FeedbackDetailType extends \SONHH\eBaySDK\Types\BaseType
{
    /**
