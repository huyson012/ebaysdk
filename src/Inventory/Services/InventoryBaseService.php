 ...
 */
class InventoryBaseService extends \SONHH\eBaySDK\Services\BaseRestService
{
    /**
     * @var array $endPoints The API endpoints.
     */
    protected static $endPoints = [
        'sandbox'    => 'https://api.sandbox.ebay.com/sell/inventory',
        'production' => 'https://api.ebay.com/sell/inventory'
    ];
    ...
    public static function getConfigDefinitions()
    {
        ...
        return $definitions + [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \SONHH\eBaySDK\Inventory\Services\InventoryService::API_VERSION,
                'required' => true
            ],
            'authorization' => [
                'valid' => ['string'],
