...
namespace SONHH\eBaySDK\Inventory\Enums;

class MarketplaceEnum
{
    const C_EBAY_AT = 'EBAY_AT';
    const C_EBAY_AU = 'EBAY_AU';
    const C_EBAY_BE_FR = 'EBAY_BE_FR';
    const C_EBAY_BE_NL = 'EBAY_BE_NL';
    const C_EBAY_CA = 'EBAY_CA';
    const C_EBAY_CA_FR = 'EBAY_CA_FR';
    ...
    const C_EBAY_MOTORS = 'EBAY_MOTORS';
