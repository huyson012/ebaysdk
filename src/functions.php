...
use SONHH\eBaySDK\Credentials\Credentials;
use SONHH\eBaySDK\Credentials\CredentialsProvider;
use SONHH\eBaySDK\Credentials\CredentialsInterface;
...
function applyCredentials($value, array &$configuration)
{
    if (is_callable($value)) {
        ...
        throw new \InvalidArgumentException(
            ...
            . 'SONHH\eBaySDK\Credentials\CredentialsInterface, an associative '
 ...
 *
 * @return \SONHH\eBaySDK\HttpHandler
 */
...
{
    if (\SONHH\eBaySDK\Sdk::$STRICT_PROPERTY_TYPES) {
        return true;
    }
