...
/**
 *
 * @property \SONHH\eBaySDK\Merchandising\Types\ProductId $productId
 * @property string $title
 * @property string $productURL
 * @property string $catalogName
 * @property string $imageURL
 * @property integer $reviewCount
 * @property \SONHH\eBaySDK\Merchandising\Types\Amount $priceRangeMin
 * @property \SONHH\eBaySDK\Merchandising\Types\Amount $priceRangeMax
 */
class Product extends \SONHH\eBaySDK\Types\BaseType
{
    ...
    private static $propertyTypes = [
        'productId' => [
            'type' => 'SONHH\eBaySDK\Merchandising\Types\ProductId',
            'repeatable' => false,
            'attribute' => false,
