<?php
namespace SONHH\eBaySDK\Browse\Services;

/**
 * Base class for the Browse service.
 */
class BrowseBaseService extends \SONHH\eBaySDK\Services\BaseRestService
{
    /**
    ...
    public static function getConfigDefinitions()
    {
        ...
        return $definitions + [
            ...
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \SONHH\eBaySDK\Browse\Services\BrowseService::API_VERSION,
                'required' => true
            ],
            'authorization' => [
                'valid' => ['string'],
