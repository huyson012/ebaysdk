...
use \SONHH\eBaySDK\JmesPath\JmesPathableArrayInterface;
...
class RepeatableType implements \ArrayAccess, \Countable, \Iterator, JmesPathableArrayInterface
{
     ...
     *
     * @throws \SONHH\eBaySDK\Exceptions\InvalidPropertyTypeException If the value is the wrong type for the array.
     */
