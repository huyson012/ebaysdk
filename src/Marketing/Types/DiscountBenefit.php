...
/**
 *
 * @property \SONHH\eBaySDK\Marketing\Types\Amount $amountOffItem
 * @property \SONHH\eBaySDK\Marketing\Types\Amount $amountOffOrder
 * @property string $percentageOffItem
 * @property string $percentageOffOrder
 */
class DiscountBenefit extends \SONHH\eBaySDK\Types\BaseType
{
    /**
