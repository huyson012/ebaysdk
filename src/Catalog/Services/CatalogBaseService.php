<?php
namespace SONHH\eBaySDK\Catalog\Services;

/**
 * Base class for the Catalog service.
 */
class CatalogBaseService extends \SONHH\eBaySDK\Services\BaseRestService
{
    /**
    ...
    public static function getConfigDefinitions()
    {
        ...
        return $definitions + [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \SONHH\eBaySDK\Catalog\Services\CatalogService::API_VERSION,
                'required' => true
            ],
            'authorization' => [
                'valid' => ['string'],
