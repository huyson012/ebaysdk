...
/**
 *
 * @property \SONHH\eBaySDK\PostOrder\Types\DateTime $holdCreationDate
 * @property string $holdReferenceId
 * @property \SONHH\eBaySDK\PostOrder\Types\DateTime $holdReleaseDate
 * @property \SONHH\eBaySDK\PostOrder\Enums\ReturnHoldStatusEnum $holdStatus
 * @property string $holdTransactionId
 */
class ReturnHoldInfoType extends \SONHH\eBaySDK\Types\BaseType
{
    /**
