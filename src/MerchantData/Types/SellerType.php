 ...
 * @property \SONHH\eBaySDK\MerchantData\Enums\CurrencyCodeType $BillingCurrency
 ...
 * @property \SONHH\eBaySDK\MerchantData\Enums\SellerLevelCodeType $SellerLevel
 * @property \SONHH\eBaySDK\MerchantData\Types\AddressType $SellerPaymentAddress
 * @property \SONHH\eBaySDK\MerchantData\Types\SchedulingInfoType $SchedulingInfo
 * @property boolean $StoreOwner
 * @property string $StoreURL
 * @property \SONHH\eBaySDK\MerchantData\Enums\SellerBusinessCodeType $SellerBusinessType
 * @property boolean $RegisteredBusinessSeller
 * @property \SONHH\eBaySDK\MerchantData\Enums\SiteCodeType $StoreSite
 * @property \SONHH\eBaySDK\MerchantData\Enums\SellerPaymentMethodCodeType $PaymentMethod
 * @property boolean $CharityRegistered
 * @property boolean $SafePaymentExempt
 * @property integer $PaisaPayEscrowEMIStatus
 * @property \SONHH\eBaySDK\MerchantData\Types\CharityAffiliationDetailsType $CharityAffiliationDetails
 * @property double $TransactionPercent
 * @property \SONHH\eBaySDK\MerchantData\Types\IntegratedMerchantCreditCardInfoType $IntegratedMerchantCreditCardInfo
 * @property \SONHH\eBaySDK\MerchantData\Types\FeatureEligibilityType $FeatureEligibility
 * @property boolean $TopRatedSeller
 * @property \SONHH\eBaySDK\MerchantData\Types\TopRatedSellerDetailsType $TopRatedSellerDetails
 * @property \SONHH\eBaySDK\MerchantData\Types\RecoupmentPolicyConsentType $RecoupmentPolicyConsent
 * @property boolean $DomesticRateTable
 */
class SellerType extends \SONHH\eBaySDK\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'SchedulingInfo' => [
            'type' => 'SONHH\eBaySDK\MerchantData\Types\SchedulingInfoType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'CharityAffiliationDetails' => [
            'type' => 'SONHH\eBaySDK\MerchantData\Types\CharityAffiliationDetailsType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'IntegratedMerchantCreditCardInfo' => [
            'type' => 'SONHH\eBaySDK\MerchantData\Types\IntegratedMerchantCreditCardInfoType',
            'repeatable' => false,
            'attribute' => false,
            'elementName' => 'IntegratedMerchantCreditCardInfo'
        ],
        'FeatureEligibility' => [
            'type' => 'SONHH\eBaySDK\MerchantData\Types\FeatureEligibilityType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'TopRatedSellerDetails' => [
            'type' => 'SONHH\eBaySDK\MerchantData\Types\TopRatedSellerDetailsType',
            'repeatable' => false,
            'attribute' => false,
            'elementName' => 'TopRatedSellerDetails'
        ],
        'RecoupmentPolicyConsent' => [
            'type' => 'SONHH\eBaySDK\MerchantData\Types\RecoupmentPolicyConsentType',
            'repeatable' => false,
            'attribute' => false,
