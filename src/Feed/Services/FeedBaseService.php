 ...
 */
class FeedBaseService extends \SONHH\eBaySDK\Services\BaseRestService
{
    /**
     * @var array $endPoints The API endpoints.
     */
    protected static $endPoints = [
        'sandbox'    => 'https://api.sandbox.ebay.com/buy/feed',
        'production' => 'https://api.ebay.com/buy/feed'
    ];
    ...
    public static function getConfigDefinitions()
    {
        ...
        return $definitions + [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \SONHH\eBaySDK\Feed\Services\FeedService::API_VERSION,
                'required' => true
            ],
            'authorization' => [
                'valid' => ['string'],
