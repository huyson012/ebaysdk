...
{
    /**
     * @param mixed A PHP object derived from SONHH\eBaySDK\Types\BaseType
    ...
    private static function assignProperties(\SONHH\eBaySDK\Types\BaseType $object, array $properties)
    {
