...
use SONHH\eBaySDK\Trading\Types;

/**
 * Base class for the Trading service.
 */
class TradingBaseService extends \SONHH\eBaySDK\Services\BaseService
{
    /**
    ...
    public static function getConfigDefinitions()
    {
        ...
        return $definitions + [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \SONHH\eBaySDK\Trading\Services\TradingService::API_VERSION,
                'required' => true
            ],
            'authorization' => [
                'valid' => ['string']
    ...
    protected function callOperationAsync($name, \SONHH\eBaySDK\Types\BaseType $request, $responseClass)
    {
        ...
        if ($this->getConfig('authorization') !== null) {
             ...
             */
            if (!isset($request->RequesterCredentials)) {
                $request->RequesterCredentials = new \SONHH\eBaySDK\Trading\Types\CustomSecurityHeaderType();
            }
