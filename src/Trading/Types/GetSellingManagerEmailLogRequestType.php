 ...
 * @property \SONHH\eBaySDK\Trading\Types\TimeRangeType $EmailDateRange
 * @property string $OrderLineItemID
 */
class GetSellingManagerEmailLogRequestType extends \SONHH\eBaySDK\Trading\Types\AbstractRequestType
{
    /**
