 ...
 * @property \SONHH\eBaySDK\Trading\Types\ItemIDArrayType $PromotionalSaleItemIDArray
 * @property \SONHH\eBaySDK\Trading\Enums\PromotionalSaleStatusCodeType $Status
 * @property \SONHH\eBaySDK\Trading\Enums\DiscountCodeType $DiscountType
 * @property double $DiscountValue
 * @property \DateTime $PromotionalSaleStartTime
 * @property \DateTime $PromotionalSaleEndTime
 * @property \SONHH\eBaySDK\Trading\Enums\PromotionalSaleTypeCodeType $PromotionalSaleType
 */
class PromotionalSaleType extends \SONHH\eBaySDK\Types\BaseType
{
    /**
