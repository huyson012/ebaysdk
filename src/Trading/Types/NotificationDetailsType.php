 ...
 * @property \SONHH\eBaySDK\Trading\Enums\NotificationEventTypeCodeType $Type
 * @property integer $Retries
 * @property \SONHH\eBaySDK\Trading\Enums\NotificationEventStateCodeType $DeliveryStatus
 * @property \DateTime $NextRetryTime
 * @property \DateTime $DeliveryTime
 * @property string $ErrorMessage
 * @property string $DeliveryURLName
 */
class NotificationDetailsType extends \SONHH\eBaySDK\Types\BaseType
{
    /**
