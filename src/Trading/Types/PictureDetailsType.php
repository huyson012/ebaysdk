 ...
 * @property \SONHH\eBaySDK\Trading\Enums\GalleryTypeCodeType $GalleryType
 * @property \SONHH\eBaySDK\Trading\Enums\PhotoDisplayCodeType $PhotoDisplay
 * @property string[] $PictureURL
 * @property \SONHH\eBaySDK\Trading\Enums\PictureSourceCodeType $PictureSource
 * @property string $GalleryDuration
 * @property \SONHH\eBaySDK\Trading\Enums\GalleryStatusCodeType $GalleryStatus
 * @property string $GalleryErrorInfo
 * @property string[] $ExternalPictureURL
 * @property \SONHH\eBaySDK\Trading\Types\ExtendedPictureDetailsType $ExtendedPictureDetails
 */
class PictureDetailsType extends \SONHH\eBaySDK\Types\BaseType
{
    ...
    private static $propertyTypes = [
        ...
        'ExtendedPictureDetails' => [
            'type' => 'SONHH\eBaySDK\Trading\Types\ExtendedPictureDetailsType',
            'repeatable' => false,
            'attribute' => false,
