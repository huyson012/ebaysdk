 ...
 * @property \SONHH\eBaySDK\Trading\Types\AmountType $Price
 * @property \SONHH\eBaySDK\Trading\Enums\BestOfferStatusCodeType $Status
 * @property integer $Quantity
 * @property string $BuyerMessage
 * @property string $SellerMessage
 * @property \SONHH\eBaySDK\Trading\Enums\BestOfferTypeCodeType $BestOfferCodeType
 * @property string $CallStatus
 */
class BestOfferType extends \SONHH\eBaySDK\Types\BaseType
{
    /**
