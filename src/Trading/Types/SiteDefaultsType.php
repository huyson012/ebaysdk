...
/**
 *
 * @property \SONHH\eBaySDK\Trading\Types\ListingDurationReferenceType[] $ListingDuration
 ...
 * @property \SONHH\eBaySDK\Trading\Enums\AdFormatEnabledCodeType $AdFormatEnabled
 ...
 * @property \SONHH\eBaySDK\Trading\Enums\ClassifiedAdPaymentMethodEnabledCodeType $ClassifiedAdPaymentMethodEnabled
 * @property boolean $ClassifiedAdShippingMethodEnabled
 * @property \SONHH\eBaySDK\Trading\Enums\ClassifiedAdBestOfferEnabledCodeType $ClassifiedAdBestOfferEnabled
 ...
 * @property \SONHH\eBaySDK\Trading\Enums\ItemSpecificsEnabledCodeType $ItemSpecificsEnabled
 ...
 * @property \SONHH\eBaySDK\Trading\Enums\INEscrowWorkflowTimelineCodeType $INEscrowWorkflowTimeline
 * @property \SONHH\eBaySDK\Trading\Types\ListingEnhancementDurationReferenceType $GalleryFeaturedDurations
 * @property boolean $PayPalRequired
 * @property \SONHH\eBaySDK\Trading\Enums\AdFormatEnabledCodeType $eBayMotorsProAdFormatEnabled
 ...
 * @property \SONHH\eBaySDK\Trading\Enums\ClassifiedAdBestOfferEnabledCodeType $eBayMotorsProBestOfferEnabled
 * @property boolean $eBayMotorsProAutoAcceptEnabled
 * @property boolean $eBayMotorsProAutoDeclineEnabled
 * @property \SONHH\eBaySDK\Trading\Enums\ClassifiedAdPaymentMethodEnabledCodeType $eBayMotorsProPaymentMethodCheckOutEnabled
 ...
 * @property \SONHH\eBaySDK\Trading\Enums\AdFormatEnabledCodeType $LocalMarketAdFormatEnabled
 ...
 * @property \SONHH\eBaySDK\Trading\Enums\ClassifiedAdBestOfferEnabledCodeType $LocalMarketBestOfferEnabled
 * @property boolean $LocalMarketAutoAcceptEnabled
 * @property boolean $LocalMarketAutoDeclineEnabled
 * @property \SONHH\eBaySDK\Trading\Enums\ClassifiedAdPaymentMethodEnabledCodeType $LocalMarketPaymentMethodCheckOutEnabled
 ...
 * @property \SONHH\eBaySDK\Trading\Enums\GeographicExposureCodeType $SpecialitySubscription
 * @property \SONHH\eBaySDK\Trading\Enums\GeographicExposureCodeType $RegularSubscription
 * @property \SONHH\eBaySDK\Trading\Enums\GeographicExposureCodeType $PremiumSubscription
 * @property \SONHH\eBaySDK\Trading\Enums\GeographicExposureCodeType $NonSubscription
 ...
 * @property \SONHH\eBaySDK\Trading\Types\StoreOwnerExtendedListingDurationsType $StoreOwnerExtendedListingDurations
 * @property boolean $ReturnPolicyEnabled
 * @property boolean $HandlingTimeEnabled
 * @property \SONHH\eBaySDK\Trading\Types\AmountType $MaxFlatShippingCost
 * @property boolean $MaxFlatShippingCostCBTExempt
 * @property \SONHH\eBaySDK\Trading\Types\AmountType $Group1MaxFlatShippingCost
 * @property \SONHH\eBaySDK\Trading\Types\AmountType $Group2MaxFlatShippingCost
 * @property \SONHH\eBaySDK\Trading\Types\AmountType $Group3MaxFlatShippingCost
 * @property \SONHH\eBaySDK\Trading\Enums\BuyerPaymentMethodCodeType[] $PaymentMethod
 * @property boolean $VariationsEnabled
 * @property boolean $FreeGalleryPlusEnabled
 * @property boolean $FreePicturePackEnabled
 * @property \SONHH\eBaySDK\Trading\Enums\ItemCompatibilityEnabledCodeType $ItemCompatibilityEnabled
 * @property integer $MinItemCompatibility
 * @property integer $MaxItemCompatibility
 * @property \SONHH\eBaySDK\Trading\Enums\ConditionEnabledCodeType $ConditionEnabled
 * @property \SONHH\eBaySDK\Trading\Types\ConditionValuesType $ConditionValues
 * @property boolean $ValueCategory
 * @property \SONHH\eBaySDK\Trading\Enums\ProductCreationEnabledCodeType $ProductCreationEnabled
 * @property \SONHH\eBaySDK\Trading\Enums\ProductIdentiferEnabledCodeType $EANEnabled
 * @property \SONHH\eBaySDK\Trading\Enums\ProductIdentiferEnabledCodeType $ISBNEnabled
 * @property \SONHH\eBaySDK\Trading\Enums\ProductIdentiferEnabledCodeType $UPCEnabled
 * @property integer $MaxGranularFitmentCount
 * @property string $CompatibleVehicleType
 * @property \SONHH\eBaySDK\Trading\Enums\PaymentOptionsGroupEnabledCodeType $PaymentOptionsGroup
 * @property \SONHH\eBaySDK\Trading\Enums\ProfileCategoryGroupCodeType $ShippingProfileCategoryGroup
 * @property \SONHH\eBaySDK\Trading\Enums\ProfileCategoryGroupCodeType $PaymentProfileCategoryGroup
 * @property \SONHH\eBaySDK\Trading\Enums\ProfileCategoryGroupCodeType $ReturnPolicyProfileCategoryGroup
 ...
 * @property \SONHH\eBaySDK\Trading\Enums\ProductRequiredEnabledCodeType $ProductRequiredEnabled
 */
class SiteDefaultsType extends \SONHH\eBaySDK\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        'ListingDuration' => [
            'type' => 'SONHH\eBaySDK\Trading\Types\ListingDurationReferenceType',
            'repeatable' => true,
            'attribute' => false,
        ...
        'GalleryFeaturedDurations' => [
            'type' => 'SONHH\eBaySDK\Trading\Types\ListingEnhancementDurationReferenceType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'StoreOwnerExtendedListingDurations' => [
            'type' => 'SONHH\eBaySDK\Trading\Types\StoreOwnerExtendedListingDurationsType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'ConditionValues' => [
            'type' => 'SONHH\eBaySDK\Trading\Types\ConditionValuesType',
            'repeatable' => false,
            'attribute' => false,
