<?php
namespace SONHH\eBaySDK\Fulfillment\Services;

/**
 * Base class for the Fulfillment service.
 */
class FulfillmentBaseService extends \SONHH\eBaySDK\Services\BaseRestService
{
    /**
    ...
    public static function getConfigDefinitions()
    {
        ...
        return $definitions + [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \SONHH\eBaySDK\Fulfillment\Services\FulfillmentService::API_VERSION,
                'required' => true
            ],
            'authorization' => [
                'valid' => ['string'],
