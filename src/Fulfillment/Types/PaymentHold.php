 ...
 * @property \SONHH\eBaySDK\Fulfillment\Types\Amount $holdAmount
 * @property string $holdReason
 * @property string $holdState
 * @property string $releaseDate
 * @property \SONHH\eBaySDK\Fulfillment\Types\SellerActionsToRelease[] $sellerActionsToRelease
 */
class PaymentHold extends \SONHH\eBaySDK\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'sellerActionsToRelease' => [
            'type' => 'SONHH\eBaySDK\Fulfillment\Types\SellerActionsToRelease',
            'repeatable' => true,
            'attribute' => false,
