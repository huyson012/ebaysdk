 ...
 * @property \SONHH\eBaySDK\Finding\Types\Amount $buyItNowPrice
 * @property \SONHH\eBaySDK\Finding\Types\Amount $convertedBuyItNowPrice
 * @property \DateTime $startTime
 * @property \DateTime $endTime
 * @property string $listingType
 * @property boolean $gift
 */
class ListingInfo extends \SONHH\eBaySDK\Types\BaseType
{
    /**
